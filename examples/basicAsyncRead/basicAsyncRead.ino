...
void setup() 
{
   ...
   // power source. The sensor values are then read in the background. Check for new values
   // with the "newValueAvailable()" function...
...
void loop() 
{
    ...
    {      
	  // Get the temerature in °Celsius.
      temperature = sensor1->getTempCelsius();
    }

    // output the temerature value to the serial port...
